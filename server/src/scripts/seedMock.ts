...
const MOCK_USERS: MockUser[] = [
  { firstName: "Maya", neighborhoodName: "Rittenhouse", interests: ["coffee_cowork", "wellness", "running"] },
  { firstName: "Devon", neighborhoodName: "Fishtown", interests: ["music_nightlife", "food_drinks", "local_events"] },
  { firstName: "Priya", neighborhoodName: "Center City", interests: ["arts_culture", "coffee_cowork", "wellness"] },
  { firstName: "Marcus", neighborhoodName: "South Philly", interests: ["fitness_outdoors", "running", "dog_owners"] },
  { firstName: "Sofia", neighborhoodName: "Old City", interests: ["arts_culture", "local_events", "food_drinks"] },
  { firstName: "Liam", neighborhoodName: "Fairmount", interests: ["running", "fitness_outdoors", "coffee_cowork"] },
  { firstName: "Aisha", neighborhoodName: "West Philly", interests: ["thrifting", "arts_culture", "music_nightlife"] },
  { firstName: "Ethan", neighborhoodName: "Northern Liberties", interests: ["music_nightlife", "food_drinks", "local_events"] },
  { firstName: "Camila", neighborhoodName: "Graduate Hospital", interests: ["wellness", "coffee_cowork", "food_drinks"] },
  { firstName: "Noah", neighborhoodName: "Manayunk", interests: ["fitness_outdoors", "dog_owners", "running"] },
  { firstName: "Zoe", neighborhoodName: "Rittenhouse", interests: ["wellness", "arts_culture", "coffee_cowork"] },
  { firstName: "Andre", neighborhoodName: "Fishtown", interests: ["music_nightlife", "thrifting", "arts_culture"] },
  { firstName: "Leila", neighborhoodName: "Center City", interests: ["food_drinks", "coffee_cowork", "local_events"] },
  { firstName: "Jonas", neighborhoodName: "South Philly", interests: ["fitness_outdoors", "local_events", "running"] },
  { firstName: "Nina", neighborhoodName: "Old City", interests: ["arts_culture", "wellness", "thrifting"] },
  { firstName: "Omar", neighborhoodName: "Fairmount", interests: ["running", "coffee_cowork", "fitness_outdoors"] },
  { firstName: "Bella", neighborhoodName: "West Philly", interests: ["arts_culture", "local_events", "food_drinks"] },
  { firstName: "Caleb", neighborhoodName: "Northern Liberties", interests: ["music_nightlife", "food_drinks", "coffee_cowork"] },
  { firstName: "Yara", neighborhoodName: "Graduate Hospital", interests: ["wellness", "running", "dog_owners"] },
  { firstName: "Felix", neighborhoodName: "Manayunk", interests: ["fitness_outdoors", "running", "local_events"] },
];
...
const MOCK_PLANS: MockPlan[] = [
  {
    ...
    tags: ["running", "fitness_outdoors"], description: "Easy 3-4 miles, coffee after. All paces welcome.", hostEmoji: "🏃",
  ...
  },
  {
    ...
    tags: ["music_nightlife", "food_drinks"], description: "Local openers then the headliner. Grab dinner downstairs first.", hostEmoji: "🎶",
  ...
  },
  {
    ...
    tags: ["arts_culture", "coffee_cowork"], description: "Slow afternoon drifting between a few shows. Coffee stop midway.", hostEmoji: "🎨",
  ...
  },
  {
    ...
    tags: ["fitness_outdoors", "local_events"], description: "Casual game, need a few more for even sides. Beginners welcome.", hostEmoji: "⚽",
  ...
  },
  {
    ...
    tags: ["arts_culture", "local_events"], description: "Loose route, meet at the flagpole then wander. Drinks after.", hostEmoji: "🖼️",
  ...
  },
  {
    ...
    tags: ["running", "fitness_outdoors"], description: "8 miles out and back. Regroup at the bridge.", hostEmoji: "🏃",
  ...
  },
  {
    ...
    tags: ["thrifting", "arts_culture"], description: "Three shops, slow afternoon, iced coffee somewhere in there.", hostEmoji: "🧥",
  ...
  },
  {
    ...
    tags: ["food_drinks", "music_nightlife"], description: "Big shared tables — easy to merge with friends of friends.", hostEmoji: "🍻",
  ...
  },
  {
    ...
    tags: ["wellness", "fitness_outdoors"], description: "Gentle flow then a loop around the park. Bring a mat.", hostEmoji: "🧘",
  ...
  },
  {
    ...
    tags: ["dog_owners", "fitness_outdoors"], description: "Bring your pup or just come hang. Easy pace.", hostEmoji: "🐕",
  ...
  },
  {
    ...
    tags: ["coffee_cowork"], description: "Heads-down for two hours, lunch after if anyone's around.", hostEmoji: "💻",
  ...
  },
  {
    ...
    tags: ["music_nightlife"], description: "Have an extra ticket to the show at Union Transfer — say hi if you'd be down.", hostEmoji: "🎟️",
  ...
  },
  {
    ...
    tags: ["food_drinks", "coffee_cowork"], description: "Always a wait — more fun together. Putting our name in early.", hostEmoji: "🥞",
  ...
  },
  {
    ...
    tags: ["fitness_outdoors", "running"], description: "Road's closed to cars — easy 10 mile out and back.", hostEmoji: "🚲",
  ...
  },
  {
    ...
    tags: ["arts_culture", "wellness"], description: "Beginner-friendly throw-in. No experience needed.", hostEmoji: "🏺",
  ...
  },
  {
    ...
    tags: ["running", "fitness_outdoors"], description: "Building toward a 10k, 9-10 min/mi pace. Mornings work best.", hostEmoji: "🏃",
  ...
  },
  {
    ...
    tags: ["arts_culture", "local_events", "music_nightlife"], description: "Friday late show — grabbing a group table.", hostEmoji: "🎤",
  ...
  },
  {
    ...
    tags: ["food_drinks", "music_nightlife"], description: "Rooftop park with skyline views. BYO snacks welcome.", hostEmoji: "🍹",
  ...
  },
  {
    ...
    tags: ["wellness", "fitness_outdoors"], description: "Best skyline view in the city. Easy 30 minute stroll.", hostEmoji: "🌅",
  ...
  },
  {
    ...
    tags: ["running", "fitness_outdoors", "local_events"], description: "Forbidden Drive loop. Trail shoes nice but not required.", hostEmoji: "🌲",
